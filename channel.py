...
class Channel(object):
    ...
    def generate(self):
        ...
        # set 2
        dx2 = (
            np.random.rand(int(self.n_clients - np.round(self.n_clients / 2))) * self.location_range
            + 200
        )
        dx1 = (
        ...
        G = np.zeros([self.n_receive_ant, self.n_RIS_ele, self.n_clients], dtype=complex)
